...
- Features that can be directly observed and tested in the final product.
...
- Describe specific actions like login, data processing, transactions
- Directly visible to users and business needs
- Easier to measure (output-based validation)
- Drive the core functionality of the system
- Documented using use cases, user stories
...
- Focus on performance, usability, security, reliability
- Describe constraints like response time, scalability, availability
- Indirectly visible, improve overall user experience
- Harder to measure, uses metrics like SLAs, benchmarks
- Influence architecture and system design decisions
